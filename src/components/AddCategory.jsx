...
const AddCategory = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  formDataWithFiles.append('categoryName', formData.categoryName); // Send category name
  if (formData.categoryImage) {
    formDataWithFiles.append('categoryImage', formData.categoryImage); // Send category image
  }
