...
import RotatingHeadings from './RotatingHeadings';
import {
  Utensils,
  ChefHat,
  Users,
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 text-center text-white">
           <h1 className="relative bottom-3 font-bold font-[cursive] text-green-600 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
              Maha Spice Caterers
            </h1>
          <motion.div
      ...
      {menuBoxes.map((box) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
            ...
            <p className="text-xs sm:text-sm opacity-80 mb-4">{box.description}</p>
            <button
